...
[account_invoice_show_currency_rate](account_invoice_show_currency_rate/) | 13.0.1.0.3 | [![victoralmau](https://github.com/victoralmau.png?size=30px)](https://github.com/victoralmau) | Show currency rate in invoices.
...
[![Runboat](https://img.shields.io/badge/runboat-Try%20me-875A7B.png)](https://runboat.odoo-community.org/builds?repo=OCA/currency&target_branch=13.0)
[![Pre-commit Status](https://github.com/OCA/currency/actions/workflows/pre-commit.yml/badge.svg?branch=13.0)](https://github.com/OCA/currency/actions/workflows/pre-commit.yml?query=branch%3A13.0)
[![Build Status](https://github.com/OCA/currency/actions/workflows/test.yml/badge.svg?branch=13.0)](https://github.com/OCA/currency/actions/workflows/test.yml?query=branch%3A13.0)
[![codecov](https://codecov.io/gh/OCA/currency/branch/13.0/graph/badge.svg)](https://codecov.io/gh/OCA/currency)
[![Translation Status](https://translation.odoo-community.org/widgets/currency-13-0/-/svg-badge.svg)](https://translation.odoo-community.org/engage/currency-13-0/?utm_source=widget)
...
[currency_rate_update](currency_rate_update/) | 13.0.1.3.1 |  | Update exchange rates using OCA modules
...
[![Build Status](https://travis-ci.org/OCA/connector.svg?branch=13.0)](https://travis-ci.org/OCA/connector)
...
[![Build Status](https://travis-ci.org/OCA/connector-accountedge.svg?branch=13.0)](https://travis-ci.org/OCA/connector-accountedge)
[![Coverage Status](https://coveralls.io/repos/OCA/connector-accountedge/badge.png?branch=13.0)](https://coveralls.io/r/OCA/connector-accountedge?branch=13.0)
...
[![Runbot Status](https://runbot.odoo-community.org/runbot/badge/flat/260/13.0.svg)](https://runbot.odoo-community.org/runbot/repo/github-com-oca-connector-infor-260)
...
Translation Status
------------------
[![Transifex Status](https://www.transifex.com/projects/p/OCA-connector-infor-13-0/chart/image_png)](https://www.transifex.com/projects/p/OCA-connector-infor-13-0)
...
[![Build Status](https://travis-ci.org/OCA/connector-lengow.svg?branch=13.0)](https://travis-ci.org/OCA/connector-lengow)
...
[![Build Status](https://travis-ci.org/OCA/connector-prestashop.svg?branch=13.0)](https://travis-ci.org/OCA/connector-prestashop)
[![Coverage Status](https://coveralls.io/repos/OCA/connector-prestashop/badge.png?branch=13.0)](https://coveralls.io/r/OCA/connector-prestashop?branch=13.0)
...
[![Build Status](https://travis-ci.org/OCA/connector-sage-50.svg?branch=13.0)](https://travis-ci.org/OCA/connector-sage-50)
[![Coverage Status](https://coveralls.io/repos/OCA/connector-sage-50/badge.png?branch=13.0)](https://coveralls.io/r/OCA/connector-sage-50?branch=13.0)
...
[![Runbot Status](https://runbot.odoo-community.org/runbot/badge/flat/270/13.0.svg)](https://runbot.odoo-community.org/runbot/repo/github-com-oca-connector-spscommerce-270)
[![Build Status](https://travis-ci.com/OCA/connector-spscommerce.svg?branch=13.0)](https://travis-ci.com/OCA/connector-spscommerce)
[![codecov](https://codecov.io/gh/OCA/connector-spscommerce/branch/13.0/graph/badge.svg)](https://codecov.io/gh/OCA/connector-spscommerce)
...
[![Build Status](https://travis-ci.org/OCA/connector-woocommerce.svg?branch=13.0)](https://travis-ci.org/OCA/connector-woocommerce)
[![Coverage Status](https://coveralls.io/repos/OCA/connector-woocommerce/badge.svg?branch=13.0&service=github)](https://coveralls.io/github/OCA/connector-woocommerce?branch=13.0)

Odoo Connector WooCommerce Modules
===================================
*Odoo WooCommerce Connector (also known as connector_woocommerce) is a bi-directional connector, 100% compatible with the last OpenERP 13.0 and latest WooCommerce versions (2.4.x).*
...
[sale_manual_delivery](sale_manual_delivery/) | 13.0.1.1.1 |  | Create manually your deliveries
...
[base_location](base_location/) | 13.0.1.1.4 |  | Enhanced zip/npa management system
...
[partner_contact_gender](partner_contact_gender/) | 13.0.1.0.1 |  | Add gender field to contacts
...
[portal_partner_select_all](portal_partner_select_all/) | 13.0.1.0.2 |  | Portal Partner Select All
...
[![Build Status](https://travis-ci.org/OCA/sale-financial.svg?branch=13.0)](https://travis-ci.org/OCA/sale-financial)
[![Coverage Status](https://coveralls.io/repos/OCA/sale-financial/badge.png?branch=13.0)](https://coveralls.io/r/OCA/sale-financial?branch=13.0)
...
[![Runboat](https://img.shields.io/badge/runboat-Try%20me-875A7B.png)](https://runboat.odoo-community.org/builds?repo=OCA/commission&target_branch=13.0)
[![Pre-commit Status](https://github.com/OCA/commission/actions/workflows/pre-commit.yml/badge.svg?branch=13.0)](https://github.com/OCA/commission/actions/workflows/pre-commit.yml?query=branch%3A13.0)
[![Build Status](https://github.com/OCA/commission/actions/workflows/test.yml/badge.svg?branch=13.0)](https://github.com/OCA/commission/actions/workflows/test.yml?query=branch%3A13.0)
...
[![Runboat](https://img.shields.io/badge/runboat-Try%20me-875A7B.png)](https://runboat.odoo-community.org/builds?repo=OCA/hr-holidays&target_branch=13.0)
[![Pre-commit Status](https://github.com/OCA/hr-holidays/actions/workflows/pre-commit.yml/badge.svg?branch=13.0)](https://github.com/OCA/hr-holidays/actions/workflows/pre-commit.yml?query=branch%3A13.0)
[![Build Status](https://github.com/OCA/hr-holidays/actions/workflows/test.yml/badge.svg?branch=13.0)](https://github.com/OCA/hr-holidays/actions/workflows/test.yml?query=branch%3A13.0)
[![codecov](https://codecov.io/gh/OCA/hr-holidays/branch/13.0/graph/badge.svg)](https://codecov.io/gh/OCA/hr-holidays)
[![Translation Status](https://translation.odoo-community.org/widgets/hr-holidays-13-0/-/svg-badge.svg)](https://translation.odoo-community.org/engage/hr-holidays-13-0/?utm_source=widget)
...
[![Build Status](https://travis-ci.org/OCA/l10n-argentina.svg?branch=13.0)](https://travis-ci.org/OCA/l10n-argentina)
[![Coverage Status](https://coveralls.io/repos/OCA/l10n-argentina/badge.png?branch=13.0)](https://coveralls.io/r/OCA/l10n-argentina?branch=13.0)
...
[![Runbot Status](https://runbot.odoo-community.org/runbot/badge/flat/278/13.0.svg)](https://runbot.odoo-community.org/runbot/repo/github-com-oca-l10n-austria-278)
[![Build Status](https://travis-ci.com/OCA/l10n-austria.svg?branch=13.0)](https://travis-ci.com/OCA/l10n-austria)
[![codecov](https://codecov.io/gh/OCA/l10n-austria/branch/13.0/graph/badge.svg)](https://codecov.io/gh/OCA/l10n-austria)
...
[![Runbot Status](https://runbot.odoo-community.org/runbot/badge/flat/267/13.0.svg)](https://runbot.odoo-community.org/runbot/repo/github-com-oca-l10n-belarus-267)
[![Build Status](https://travis-ci.com/OCA/l10n-belarus.svg?branch=13.0)](https://travis-ci.com/OCA/l10n-belarus)
[![codecov](https://codecov.io/gh/OCA/l10n-belarus/branch/13.0/graph/badge.svg)](https://codecov.io/gh/OCA/l10n-belarus)
...
[![Runbot Status](https://runbot.odoo-community.org/runbot/badge/flat/120/13.0.svg)](https://runbot.odoo-community.org/runbot/repo/github-com-oca-l10n-canada-120)
[![Build Status](https://travis-ci.org/OCA/l10n-canada.svg?branch=13.0)](https://travis-ci.org/OCA/l10n-canada)
[![Coverage Status](https://coveralls.io/repos/OCA/l10n-canada/badge.svg?branch=13.0)](https://coveralls.io/r/OCA/l10n-canada?branch=13.0)
...
Translation Status
------------------
[![Transifex Status](https://www.transifex.com/projects/p/OCA-l10n-canada-13-0/chart/image_png)](https://www.transifex.com/projects/p/OCA-l10n-canada-13-0)
...
[![Runbot Status](https://runbot.odoo-community.org/runbot/badge/flat/195/13.0.svg)](https://runbot.odoo-community.org/runbot/repo/github-com-oca-l10n-columbia-201)
[![Build Status](https://travis-ci.org/OCA/l10n-columbia.svg?branch=13.0)](https://travis-ci.org/OCA/l10n-columbia)
[![Coverage Status](https://coveralls.io/repos/OCA/l10n-columbia/badge.svg?branch=13.0&service=github)](https://coveralls.io/github/OCA/l10n-columbia?branch=13.0)
...
Translation Status
------------------
[![Transifex Status](https://www.transifex.com/projects/p/OCA-l10n-columbia-13-0/chart/image_png)](https://www.transifex.com/projects/p/OCA-l10n-columbia-13-0)
...
[![Runbot Status](https://runbot.odoo-community.org/runbot/badge/flat/196/13.0.svg)](https://runbot.odoo-community.org/runbot/repo/github-com-oca-l10n-costa-rica-201)
[![Build Status](https://travis-ci.org/OCA/l10n-costa-rica.svg?branch=13.0)](https://travis-ci.org/OCA/l10n-costa-rica)
[![Coverage Status](https://coveralls.io/repos/OCA/l10n-costa-rica/badge.svg?branch=13.0&service=github)](https://coveralls.io/github/OCA/l10n-costa-rica?branch=13.0)
...
Translation Status
------------------
[![Transifex Status](https://www.transifex.com/projects/p/OCA-l10n-costa-rica-13-0/chart/image_png)](https://www.transifex.com/projects/p/OCA-l10n-costa-rica-13-0)
...
[![Runbot Status](https://runbot.odoo-community.org/runbot/badge/flat/261/13.0.svg)](https://runbot.odoo-community.org/runbot/repo/github-com-oca-l10n-croatia-261)
[![Build Status](https://travis-ci.org/OCA/l10n-croatia.svg?branch=13.0)](https://travis-ci.org/OCA/l10n-croatia)
[![codecov](https://codecov.io/gh/OCA/l10n-croatia/branch/13.0/graph/badge.svg)](https://codecov.io/gh/OCA/l10n-croatia)
...
[![Runbot Status](https://runbot.odoo-community.org/runbot/badge/flat/272/13.0.svg)](https://runbot.odoo-community.org/runbot/repo/github-com-oca-l10n-greece-272)
[![Build Status](https://travis-ci.org/OCA/l10n-greece.svg?branch=13.0)](https://travis-ci.org/OCA/l10n-greece)
[![codecov](https://codecov.io/gh/OCA/l10n-greece/branch/13.0/graph/badge.svg)](https://codecov.io/gh/OCA/l10n-greece)
...
[![Build Status](https://travis-ci.org/OCA/l10n-indonesia.svg?branch=13.0)](https://travis-ci.org/OCA/l10n-indonesia)
[![Coverage Status](https://coveralls.io/repos/OCA/l10n-indonesia/badge.svg?branch=13.0&service=github)](https://coveralls.io/github/OCA/l10n-indonesia?branch=13.0)
...
[![Runbot Status](https://runbot.odoo-community.org/runbot/badge/flat/201/13.0.svg)](https://runbot.odoo-community.org/runbot/repo/github-com-oca-l10n-ireland-201)
[![Build Status](https://travis-ci.org/OCA/l10n-ireland.svg?branch=13.0)](https://travis-ci.org/OCA/l10n-ireland)
[![Coverage Status](https://coveralls.io/repos/OCA/l10n-ireland/badge.svg?branch=13.0&service=github)](https://coveralls.io/github/OCA/l10n-ireland?branch=13.0)
...
Translation Status
------------------
[![Transifex Status](https://www.transifex.com/projects/p/OCA-l10n-ireland-13-0/chart/image_png)](https://www.transifex.com/projects/p/OCA-l10n-ireland-13-0)
...
[![Runbot Status](https://runbot.odoo-community.org/runbot/badge/flat/123/13.0.svg)](https://runbot.odoo-community.org/runbot/repo/github-com-oca-l10n-luxemburg-123)
[![Build Status](https://travis-ci.org/OCA/l10n-luxemburg.svg?branch=13.0)](https://travis-ci.org/OCA/l10n-luxemburg)
[![Coverage Status](https://coveralls.io/repos/OCA/l10n-luxemburg/badge.svg?branch=13.0)](https://coveralls.io/r/OCA/l10n-luxemburg?branch=13.0)
...
Translation Status
------------------
[![Transifex Status](https://www.transifex.com/projects/p/OCA-l10n-luxemburg-13-0/chart/image_png)](https://www.transifex.com/projects/p/OCA-l10n-luxemburg-13-0)

----
----

# From [https://github.com/OCA/l10n-mexico.git](https://github.com/OCA/l10n-mexico.git)
[![Runbot Status](https://runbot.odoo-community.org/runbot/badge/flat/193/13.0.svg)](https://runbot.odoo-community.org/runbot/repo/github-com-oca-l10n-mexico-201)
[![Build Status](https://travis-ci.org/OCA/l10n-mexico.svg?branch=13.0)](https://travis-ci.org/OCA/l10n-mexico)
[![Coverage Status](https://coveralls.io/repos/OCA/l10n-mexico/badge.svg?branch=13.0&service=github)](https://coveralls.io/github/OCA/l10n-mexico?branch=13.0)
...
Translation Status
------------------
[![Transifex Status](https://www.transifex.com/projects/p/OCA-l10n-mexico-13-0/chart/image_png)](https://www.transifex.com/projects/p/OCA-l10n-mexico-13-0)
...
[![Runbot Status](https://runbot.odoo-community.org/runbot/badge/flat/211/13.0.svg)](https://runbot.odoo-community.org/runbot/repo/github-com-oca-l10n-peru-201)
[![Build Status](https://travis-ci.org/OCA/l10n-peru.svg?branch=13.0)](https://travis-ci.org/OCA/l10n-peru)
[![Coverage Status](https://coveralls.io/repos/OCA/l10n-peru/badge.svg?branch=13.0&service=github)](https://coveralls.io/github/OCA/l10n-peru?branch=13.0)
...
Translation Status
------------------
[![Transifex Status](https://www.transifex.com/projects/p/OCA-l10n-peru-13-0/chart/image_png)](https://www.transifex.com/projects/p/OCA-l10n-peru-13-0)
...
[![Runbot Status](https://runbot.odoo-community.org/runbot/badge/flat/265/13.0.svg)](https://runbot.odoo-community.org/runbot/repo/github-com-oca-l10n-poland-265)
...
[![Runboat](https://img.shields.io/badge/runboat-Try%20me-875A7B.png)](https://runboat.odoo-community.org/builds?repo=OCA/l10n-switzerland&target_branch=13.0)
...
addon | version | maintainers | summary
--- | --- | --- | ---
[ebill_paynet](ebill_paynet/) | 13.0.1.1.0 |  | Paynet platform bridge implementation
[ebill_paynet_customer_free_ref](ebill_paynet_customer_free_ref/) | 13.0.1.0.1 |  | Glue module: ebill_paynet and sale_order_customer_free_ref
...
[![Runbot Status](https://runbot.odoo-community.org/runbot/badge/flat/192/13.0.svg)](https://runbot.odoo-community.org/runbot/repo/github-com-oca-l10n-taiwan-201)
...
![Licence](https://img.shields.io/badge/licence-AGPL--3-blue.svg)
[![Runbot Status](https://runbot.odoo-community.org/runbot/badge/flat/238/13.0.svg)](https://runbot.odoo-community.org/runbot/repo/github-com-oca-l10n-thailand-238)
...
[![Runbot Status](https://runbot.odoo-community.org/runbot/badge/flat/119/13.0.svg)](https://runbot.odoo-community.org/runbot/repo/github-com-oca-l10n-turkey-220)
[![Build Status](https://travis-ci.org/OCA/l10n-turkey.svg?branch=13.0)](https://travis-ci.org/OCA/l10n-turkey)
[![Coverage Status](https://coveralls.io/repos/OCA/l10n-turkey/badge.png?branch=13.0)](https://coveralls.io/r/OCA/l10n-turkey?branch=13.0)
...
Translation Status
------------------
[![Transifex Status](https://www.transifex.com/projects/p/OCA-l10n-turkey-13-0/chart/image_png)](https://www.transifex.com/projects/p/OCA-l10n-turkey-13-0)
...
[![Runbot Status](https://runbot.odoo-community.org/runbot/badge/flat/203/13.0.svg)](https://runbot.odoo-community.org/runbot/repo/github-com-oca-l10n-usa-203)
[![Build Status](https://travis-ci.org/OCA/l10n-usa.svg?branch=13.0)](https://travis-ci.org/OCA/l10n-usa)
[![Coverage Status](https://coveralls.io/repos/OCA/l10n-usa/badge.svg?branch=13.0)](https://coveralls.io/r/OCA/l10n-usa?branch=13.0)
...
Translation Status
------------------
[![Transifex Status](https://www.transifex.com/projects/p/OCA-l10n-usa-13-0/chart/image_png)](https://www.transifex.com/projects/p/OCA-l10n-usa-13-0)
...
[![Runbot Status](https://runbot.odoo-community.org/runbot/badge/flat/116/13.0.svg)](https://runbot.odoo-community.org/runbot/repo/github-com-oca-l10n-vietnam-{number?})
[![Build Status](https://travis-ci.org/OCA/l10n-vietnam.svg?branch=13.0)](https://travis-ci.org/OCA/l10n-vietnam)
[![codecov](https://codecov.io/gh/OCA/l10n-vietnam/branch/13.0/graph/badge.svg)](https://codecov.io/gh/OCA/l10n-vietnam)
...
Translation Status
------------------
[![Transifex Status](https://www.transifex.com/projects/p/OCA-l10n-vietnam-13-0/chart/image_png)](https://www.transifex.com/projects/p/OCA-l10n-vietnam-13-0)
...
[purchase_blanket_order](purchase_blanket_order/) | 13.0.3.0.0 |  | Purchase Blanket Orders
...
[purchase_manual_delivery](purchase_manual_delivery/) | 13.0.1.0.0 |  | Prevents pickings to be auto generated upon Purchase Order confirmation and adds the ability to manually generate them as the supplier confirms the different purchase order lines.
...
[purchase_order_line_sequence](purchase_order_line_sequence/) | 13.0.1.1.1 |  | Adds sequence to PO lines and propagates it toInvoice lines and Stock Moves
...
[![Build Status](https://travis-ci.org/OCA/product-kitting.svg?branch=13.0)](https://travis-ci.org/OCA/product-kitting)
...
[![Runboat](https://img.shields.io/badge/runboat-Try%20me-875A7B.png)](https://runboat.odoo-community.org/builds?repo=OCA/product-pack&target_branch=13.0)
[![Pre-commit Status](https://github.com/OCA/product-pack/actions/workflows/pre-commit.yml/badge.svg?branch=13.0)](https://github.com/OCA/product-pack/actions/workflows/pre-commit.yml?query=branch%3A13.0)
[![Build Status](https://github.com/OCA/product-pack/actions/workflows/test.yml/badge.svg?branch=13.0)](https://github.com/OCA/product-pack/actions/workflows/test.yml?query=branch%3A13.0)
[![codecov](https://codecov.io/gh/OCA/product-pack/branch/13.0/graph/badge.svg)](https://codecov.io/gh/OCA/product-pack)
[![Translation Status](https://translation.odoo-community.org/widgets/product-pack-13-0/-/svg-badge.svg)](https://translation.odoo-community.org/engage/product-pack-13-0/?utm_source=widget)
...
[![Build Status](https://travis-ci.org/OCA/project-reporting.svg?branch=13.0)](https://travis-ci.org/OCA/project-reporting)
[![Coverage Status](https://coveralls.io/repos/OCA/project-reporting/badge.png?branch=13.0)](https://coveralls.io/r/OCA/project-reporting?branch=13.0)
...
[![Runbot Status](https://runbot.odoo-community.org/runbot/badge/flat/${REPO_ID}/13.0.svg)](https://runbot.odoo-community.org/runbot/repo/github-com-oca-project-agile-${REPO_ID})
[![Build Status](https://travis-ci.org/OCA/${REPO_NAME}.svg?branch=${BRANCH_NAME})](https://travis-ci.org/OCA/${REPO_NAME})
...
[![Build Status](https://travis-ci.org/OCA/connector-redmine.svg?branch=13.0)](https://travis-ci.org/OCA/connector-redmine)
...
[storage_backend_ftp](storage_backend_ftp/) | 13.0.1.2.0 |  | Implement FTP Storage
...
[storage_image_product](storage_image_product/) | 13.0.3.0.2 |  | Link images to products and categories
...
[![Build Status](https://travis-ci.org/OCA/webkit-tools.svg?branch=13.0)](https://travis-ci.org/OCA/webkit-tools)
[![Coverage Status](https://img.shields.io/coveralls/OCA/webkit-tools.svg?branch=13.0)](https://coveralls.io/r/OCA/webkit-tools?branch=13.0)
...
![Licence](https://img.shields.io/badge/licence-AGPL--3-blue.svg)
[![Runbot Status](https://runbot.odoo-community.org/runbot/badge/flat/254/13.0.svg)](https://runbot.odoo-community.org/runbot/repo/github-com-oca-server-env-254)
[![Build Status](https://travis-ci.org/OCA/server-env.svg?branch=13.0)](https://travis-ci.org/OCA/server-env)
[![Coverage Status](https://coveralls.io/repos/OCA/server-env/badge.svg?branch=13.0)](https://coveralls.io/r/OCA/server-env?branch=13.0)
...
Translation Status
------------------
[![Transifex Status](https://www.transifex.com/projects/p/OCA-server-env-13-0/chart/image_png)](https://www.transifex.com/projects/p/OCA-server-env-13-0)
...
[![Runbot Status](https://runbot.odoo-community.org/runbot/badge/flat/253/13.0.svg)](https://runbot.odoo-community.org/runbot/repo/github-com-oca-server-backend-253)
...
[![Runbot Status](https://runbot.odoo-community.org/runbot/badge/flat/294/13.0.svg)](https://runbot.odoo-community.org/runbot/repo/github-com-oca-role-policy-294)
[![Build Status](https://travis-ci.org/OCA/role-policy.svg?branch=13.0)](https://travis-ci.org/OCA/role-policy)
[![Coverage Status](https://coveralls.io/repos/OCA/role-policy/badge.png?branch=13.0)](https://coveralls.io/r/OCA/role-policy?branch=13.0)

Role Policy
===========

This project aims to deal with modules related to roles and policies.

----
----

# From [https://github.com/OCA/vertical-association.git](https://github.com/OCA/vertical-association.git)
[![Runbot Status](https://runbot.odoo-community.org/runbot/badge/flat/208/13.0.svg)](https://runbot.odoo-community.org/runbot/repo/github-com-oca-vertical-association-208)
...
[![Build Status](https://travis-ci.org/OCA/vertical-hotel.svg?branch=13.0)](https://travis-ci.org/OCA/vertical-hotel)
[![Coverage Status](https://coveralls.io/repos/OCA/vertical-hotel/badge.png?branch=13.0)](https://coveralls.io/r/OCA/vertical-hotel?branch=13.0)
...
[![Build Status](https://travis-ci.org/OCA/vertical-isp.svg?branch=13.0)](https://travis-ci.org/OCA/vertical-isp)
...
[![Build Status](https://travis-ci.org/OCA/edition-mgmt.svg?branch=13.0)](https://travis-ci.org/OCA/edition-mgmt)
...
[![Build Status](https://travis-ci.org/OCA/vertical-construction.svg?branch=13.0)](https://travis-ci.org/OCA/vertical-construction)
[![Coverage Status](https://coveralls.io/repos/OCA/vertical-construction/badge.svg?branch=13.0)](https://coveralls.io/r/OCA/vertical-construction?branch=13.0)
...
[![Build Status](https://travis-ci.org/OCA/vertical-travel.svg?branch=13.0)](https://travis-ci.org/OCA/vertical-travel)
...
[website_google_analytics_4](website_google_analytics_4/) | 13.0.1.1.0 |  | Google Analytics 4 integration
...
[![Runboat](https://img.shields.io/badge/runboat-Try%20me-875A7B.png)](https://runboat.odoo-community.org/builds?repo=OCA/website-cms&target_branch=13.0)
